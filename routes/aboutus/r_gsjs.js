...
/*公司介绍*/
router.get(['/xxpl','/xxpl/gsjs/'], function(req, res) {
...
/*团队介绍*/
router.get(['/xxpl/tdjs/'], function(req, res) {
    var pageData = {
        seo : {
...
/*合作伙伴*/
router.get('/xxpl/hzhb/*', function(req, res) {
    var pageData = {
        seo : {
...
/*招贤纳士*/
router.get('/xxpl/zxns/', function(req, res) {
    var pageData = {
        seo : {
            title : '金投手招贤纳士_金投手招贤纳士-金投手官网',
            keywords : '金投手招贤纳士,金投手招贤纳士,金投手招贤纳士信息',
            discription : '金投手招贤纳士主要为用户展示金投手高管管理团队的招贤纳士简介信息。'
        },
        curTab:'招贤纳士',
        curUrlTitle:'信息披露'
    };
    res.render('aboutus/zxns',pageData);
});

/*联系我们*/
router.get('/xxpl/lxwm/', function(req, res) {
    var pageData = {
        seo : {
